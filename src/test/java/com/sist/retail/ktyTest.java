...
import com.sist.retail.master.dao.LoginDaoImpl;
...
/*	@Before
	...
	public void createBean() {
		assertThat(this.loginDaoImpl, is(notNullValue()));
	}
	...
	public void reg(){
		...
		for(MasterStoreVo vo:list){
			flag+=this.loginDaoImpl.do_add(vo);
		}
	...
	public void login(){
		...
		MasterStoreVo afterAdd=(MasterStoreVo)loginDaoImpl.do_login(vo);
	...
	public void search(){
		...
		vo.setStoId("00001");
		MasterStoreVo search = (MasterStoreVo) loginDaoImpl.do_searchOne(vo);
	...
	public void update(){
		...
		flag = loginDaoImpl.do_update(vo);
